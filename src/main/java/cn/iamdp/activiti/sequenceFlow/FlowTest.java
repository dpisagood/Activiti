package cn.iamdp.activiti.sequenceFlow;
...
public class FlowTest {	
	...
	public void deploymentProcess(){
		InputStream bpmnStream=this.getClass().getResourceAsStream("flowbpmn.bpmn");
		InputStream pngStream=this.getClass().getResourceAsStream("flowbpmn.png");
		Deployment deployment=processEngine.getRepositoryService()//得到流程定义和部署对象相关的service
						.createDeployment()//创建部署对象
						.name("流程连线")
						.addInputStream("flowbpmn.bpmn", bpmnStream)
						.addInputStream("flowbpmn.png", pngStream)
						.deploy();//部署完成
